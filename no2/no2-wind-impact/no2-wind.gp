...
set title "NO2-B43F wind evaluation impact. Fan test 10/10/10 min\n\
...
"no2-2.dat" using 1:($6)    axes x1y1 title "NO2-04" with line ls 4, \
"no2.dat" using 1:($6)    axes x1y1 title "NO2-02" with line ls 5, \
"no2.dat" using 1:($7)    axes x1y1 title "NO2-03" with line ls 6;
